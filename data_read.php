...
<body>
    <div class="bd">
        <div class="container">
            ...
            <h1>Data Mahasiswa Polman ASTRA</h1>
            ...
            <table id="example" class="table table-striped" style="width:100%; border: 1px solid #ddd;" >
                <thead>
                    <tr>
                        ...
                        <th style="padding: 15px; background-color: #005BAA; color: white; text-align: center;">NIM</th>
                        ...
                        <th style="padding: 15px; background-color: #005BAA; color: white; text-align: center;">Action</th>
                    </tr>
                </thead>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo '
                                <tr>
                                    ...
                                    <td style="border: 1px solid #ddd; text-align: center;">'.$row['nim'].'</td>
                                    <td style="border: 1px solid #ddd; text-align: center;">'.$row['nama'].'</td>
                                    <td style="border: 1px solid #ddd; text-align: center;">'.$row['prodi'].'</td>
                                    <td style="border: 1px solid #ddd; ">
                                        <a style="margin-left: 6px;" href="update.php?nim='.$row['nim'].'">
                                            <button  type="button" class="btn btn-warning">Ubah</button>
                                        </a>
                                        <a href="delete_db.php?nim='.$row['nim'].'" onclick="return confirm(\'Apakah anda yakin ingin menghapus data ini?\')">
